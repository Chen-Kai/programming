package com.gmail.dailyefforts.android.basic.gesture;
...
import com.gmail.dailyefforts.android.basic.gesture.MyGestureLisener.IDoubleTapHandler;
...
public class GestureView extends View {
	...
	public GestureView(final Context context, AttributeSet attrs) {
		...
		mDoubleTapHandler = new MyGestureLisener.IDoubleTapHandler() {
			...
			public void onDoubleTap() {
				Toast.makeText(context, "onDoubleTap", Toast.LENGTH_SHORT)
						.show();
			}
		};
	...
	protected void onDraw(Canvas canvas) {
		...
		canvas.drawRect(canvasWidth / 4.0F, canvasHeight / 4.0F,
				3 * canvasWidth / 4.0F, 3 * canvasHeight / 4.0F, mPaint);
	}
